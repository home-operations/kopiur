...
| `kopiur_snapshot_delete_batch_members_total`   | counter     | `outcome` (`deleted`/`failed`)             | a `Snapshot` resolved by a batch-delete Job, counted per member independently of the whole-Job outcome                                                                                     |
