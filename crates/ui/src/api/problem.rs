...
mod tests {
    ...
    #[test]
    fn both_proxy_secret_failures_share_one_indistinguishable_problem() {
        ...
        assert_eq!(mismatch.r#type, missing.r#type);
        assert_eq!(mismatch.what, missing.what);
        assert_eq!(mismatch.why, missing.why);
    }
